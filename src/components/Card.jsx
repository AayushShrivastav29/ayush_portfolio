...
const Card = ({ title, image, description, link,boxHeight }) => {
  ...
  return (
    <motion.div
      ...
      className={`bg-white rounded-lg border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700 my-8 `}
